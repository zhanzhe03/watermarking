...
public class EntityInitializer {
    ...
    public void entityEnitialize() {
        ...
        Donation donation1 = new Donation("D001", new Date(17, 4, 2023), "Processing", donor1);
        Donation donation2 = new Donation("D002", new Date(20, 4, 2023), "Processing", donor2);
        Donation donation3 = new Donation("D003", new Date(4, 5, 2023), "Fully Distributed", donor3);
        Donation donation4 = new Donation("D004", new Date(4, 5, 2023), "Processing", donor5);
        Donation donation5 = new Donation("D005", new Date(10, 6, 2023), "Processing", donor7);
        Donation donation6 = new Donation("D006", new Date(17, 6, 2023), "Processing", donor7);
        Donation donation7 = new Donation("D007", new Date(24, 8, 2023), "Processing", donor8);
        Donation donation8 = new Donation("D008", new Date(5, 10, 2023), "Processing", donor10);
        Donation donation9 = new Donation("D009", new Date(8, 10, 2023), "Processing", donor12);
        Donation donation10 = new Donation("D010", new Date(1, 12, 2023), "Processing", donor14);
        Donation donation11 = new Donation("D011", new Date(22, 12, 2023), "Processing", donor14);
        Donation donation12 = new Donation("D012", new Date(23,12, 2023), "Processing", donor15);
        Donation donation13 = new Donation("D013", new Date(31, 1, 2024), "Processing", donor15);
        Donation donation14 = new Donation("D014", new Date(14, 2, 2024), "Processing", donor17);
        Donation donation15 = new Donation("D015", new Date(28, 2, 2024), "Processing", donor17);
        Donation donation16 = new Donation("D016", new Date(11, 3, 2024), "Processing", donor18);
        Donation donation17 = new Donation("D017", new Date(13, 4, 2024), "Processing", donor20);
        Donation donation18 = new Donation("D018", new Date(13, 5, 2024), "Processing", donor20);
        Donation donation19 = new Donation("D019", new Date(20, 5, 2024), "Processing", donor1);
        Donation donation20 = new Donation("D020", new Date(17, 7, 2024), "Processing", donor1);
        Donation donation21 = new Donation("D021", new Date(10, 8, 2024), "Pending", donor21);
        Donation donation22 = new Donation("D022", new Date(8, 9, 2024), "Pending", donor30);
        Donation donation23 = new Donation("D023", new Date(8, 9, 2024), "Pending", donor25);
        Donation donation24 = new Donation("D024", new Date(9, 9, 2024), "Pending", donor26);
        Donation donation25 = new Donation("D025", new Date(9, 9, 2024), "Pending", donor27);
        ...
        Distribution distribution5 = new Distribution("DIST005", new Date(13, 7, 2023));
        ...
        Distribution distribution29 = new Distribution("DIST029", new Date(3, 9, 2024));
        ...
        Distribution distribution30 = new Distribution("DIST030", new Date(3, 9, 2024), doneeList4);

        Distribution distribution31 = new Distribution("DIST031", new Date(7, 9, 2024));

        Distribution distribution32 = new Distribution("DIST032", new Date(8, 9, 2024));
...
// Create a selected item
        ...
        distributions.add(distribution31);
        distributions.add(distribution32);
