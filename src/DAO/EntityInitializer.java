...
public class EntityInitializer {
    ...
    public void entityEnitialize() {
        ...
        donors.add(new Donor("DR005", "Private Organization", "ABC Pvt Ltd", "John Lee", "012-6837281", "johnlee@abc.com", "20, Jalan Tun Razak, 50400 Kuala Lumpur", new Date(25, 6, 2022), "Active"));
        donors.add(new Donor("DR006", "Public Organization", "XYZ Foundation", "Wong Mei", "012-6472819", "wongmei@xyz.org", "15, Jalan Bukit Bintang, 55100 Kuala Lumpur", new Date(5, 7, 2022), "Inactive"));
        donors.add(new Donor("DR007", "Government Organization", "Ministry of Health", "Tan Ah Kow", "012-7351827", "tanahkow@moh.gov.my", "Jalan Cempaka, 50490 Kuala Lumpur", new Date(11, 7, 2022), "Active"));
        ...
        donors.add(new Donor("DR009", "Private Organization", "MNO Corporation", "Ong Siew Mun", "012-8129837", "ongsm@mno.com", "18, Jalan Raja Chulan, 50200 Kuala Lumpur", new Date(28, 7, 2022), "Active"));
        donors.add(new Donor("DR010", "Public Organization", "DEF Trust", "Lim Swee Ling", "012-8734590", "limsweeling@deftrust.org", "Jalan Tun HS Lee, 50000 Kuala Lumpur", new Date(3, 8, 2022), "Prospect"));
        donors.add(new Donor("DR011", "Government Organization", "Department of Education", "Chong Kar Ling", "012-8491023", "karling.chong@education.gov.my", "Jalan Bukit Jalil, 57000 Kuala Lumpur", new Date(10, 8, 2022), "Inactive"));
        ...
        donors.add(new Donor("DR013", "Private Organization", "GHI Sdn Bhd", "Cheong Siew Fong", "012-6745120", "cheongsf@ghi.com", "Jalan Sultan Ismail, 50250 Kuala Lumpur", new Date(21, 8, 2022), "Banned"));
        donors.add(new Donor("DR014", "Public Organization", "UVW Charities", "Yap Wei Jian", "012-6845127", "yapweijian@uvw.org", "Jalan Raja Abdullah, 50300 Kuala Lumpur", new Date(29, 8, 2022), "Active"));
        donors.add(new Donor("DR015", "Government Organization", "National Welfare Department", "Low Kah Meng", "012-7891034", "kahmeng@welfare.gov.my", "Jalan Kuching, 51200 Kuala Lumpur", new Date(5, 9, 2022), "Inactive"));
        ...
        donors.add(new Donor("DR017", "Private Organization", "JKL Holdings", "Khoo Kai Ling", "012-8749123", "kailing@jkl.com", "Jalan Tun Sambanthan, 50470 Kuala Lumpur", new Date(15, 9, 2022), "Active"));
        donors.add(new Donor("DR018", "Public Organization", "MNZ Association", "Chia Wei Liang", "012-8941235", "chiaweiliang@mnz.org", "Jalan Raja Laut, 50350 Kuala Lumpur", new Date(22, 9, 2022), "Inactive"));
        donors.add(new Donor("DR019", "Government Organization", "Ministry of Finance", "Tan Cheng Wee", "012-8120456", "chengwee@mof.gov.my", "Jalan Duta, 50480 Kuala Lumpur", new Date(28, 9, 2022), "Active"));
        ...
        donors.add(new Donor("DR021", "Public Organization", "Tan Mei Ling", "Tan Mei Ling", "012-4567890", "meiling.tan@gmail.com", "11, Jalan Taman Megah, 47301 Petaling Jaya, Selangor", new Date(5, 8, 2022), "Active"));
        donors.add(new Donor("DR022", "Private Organization", "Khoo Wen Jian", "Khoo Wen Jian", "016-2345678", "wenjian.khoo@gmail.com", "22, Lorong Bukit Anggerik, 56100 Kuala Lumpur", new Date(12, 9, 2022), "Inactive"));
        donors.add(new Donor("DR023", "Government Organization", "Education Support Fund", "Low Zhi Hao", "013-9876543", "zhihao.low@gov.my", "5, Persiaran Perdana, 62100 Putrajaya", new Date(18, 7, 2022), "Banned"));
        ...
        donors.add(new Donor("DR025", "Public Organization", "Green Earth Foundation", "Lai Wai Mun", "014-2345678", "waimun.lai@gmail.com", "3, Jalan Damansara, 60000 Kuala Lumpur", new Date(22, 8, 2022), "Prospect"));
        donors.add(new Donor("DR026", "Private Organization", "Tech Innovators", "Yap Wei Jie", "019-3456789", "weijie.yap@techinnovators.com", "10, Jalan Teknologi, 47810 Petaling Jaya, Selangor", new Date(3, 10, 2022), "Inactive"));
        donors.add(new Donor("DR027", "Government Organization", "Healthcare Development Fund", "Ng Wei Keat", "012-5436789", "weikeat.ng@gov.my", "7, Jalan Bukit Bintang, 55100 Kuala Lumpur", new Date(1, 9, 2022), "Active"));
        ...
        donors.add(new Donor("DR029", "Public Organization", "Wildlife Conservation Society", "Chong Wai Leng", "011-2345678", "waileng.chong@gmail.com", "4, Jalan Ampang, 50450 Kuala Lumpur", new Date(25, 8, 2022), "Active"));
        donors.add(new Donor("DR030", "Private Organization", "Youth Empowerment Hub", "Chan Mei Yen", "013-7654321", "meiyen.chan@gmail.com", "9, Jalan Bangsar, 59000 Kuala Lumpur", new Date(15, 9, 2022), "Prospect"));
